...
public sealed class VariableMappingCollapsing
{
    ...
    public void ShouldCollapse_Select()
    {
        ...
        parsed.VariableMappings.Should().Contain(vm =>
            vm.Alias == "c" && vm.Table.TableName == "customers" && vm.Table.DataSourceName == "erp");
    ...
    public void ShouldNotCollapse_Select_ThrowVariableNotFound()
    {
        ...
        var action = () => SemanticTransformer.Transform(parsed);
    ...
    public void ShouldCollapse_Join()
    {
        ...
        SemanticTransformer.Transform(parsed);
        parsed.Join.Single().Expression
            .ShouldBeBinaryOperator("=", new AttributeSpecifier("erp", "orders", "name"), "Apple");
    }
