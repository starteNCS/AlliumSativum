...
public sealed class JoinSelectQueries
{
    ...
    public void ShouldParse_SingleJoin()
    {
        ...
        result.VariableMappings.Should().Contain(mapping =>
            mapping.Alias == "c" && mapping.Table.TableName == "customers" && mapping.Table.DataSourceName == "erp");
    ...
    public void ShouldParse_MultiJoin()
    {
        ...
        result.VariableMappings.Should().Contain(mapping =>
            mapping.Alias == "c" && mapping.Table.TableName == "customers" && mapping.Table.DataSourceName == "erp");
        result.VariableMappings.Should().Contain(mapping =>
            mapping.Alias == "o" && mapping.Table.TableName == "orders" && mapping.Table.DataSourceName == "erp");
        ...
        secondJoin.Expression.ShouldBeBinaryOperator("=", new VariableMappingSpecifier("o", "number"),
            new VariableMappingSpecifier("c", "number"));
    }
}