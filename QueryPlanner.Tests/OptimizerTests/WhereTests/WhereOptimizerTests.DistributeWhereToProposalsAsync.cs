...
public sealed class DistributeWhereToProposalsAsyncTests
{
    ...
    public async Task Should_Return_Same_Plan_If_No_Unplanned_Where()
    {
        ...
        var scanPop = new PushdownRestCallPlanOperator(Guid.NewGuid(), "GET",
            "https://allium-sativum.honsel.dev/cs_algorithm", null)
        {
    ...
    public async Task Should_Return_Same_Plan_If_Only_OnPremise()
    {
        ...
        var pop = await _fixture.WhereOptimizer.DistributeWhereToProposalsAsync(planContainer, onPremises,
            new SelectDto());
    ...
    public async Task Should_Return_Unplanned_Where()
    {
        ...
        var pop = await _fixture.WhereOptimizer.DistributeWhereToProposalsAsync(planContainer, new SelectDto(),
            unplanned);
