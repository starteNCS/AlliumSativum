...
public static class SemanticTransformer
{
    ...
    private static IExpressionNode? CollapseVariableMappingsOfExpression(List<VariableMapping> variableMappings, IExpressionNode? expression)
    {
        if (expression == null)
        {
            return null;
    ...
    private static void CollapseVariableMappingsOfExpressionRef(List<VariableMapping> variableMappings, ref IExpressionNode? expression)
    {
        if (expression == null)
        {
            return;
