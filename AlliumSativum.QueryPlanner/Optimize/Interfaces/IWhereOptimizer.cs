...
{
    /// <summary>
    ///     Distributes all CNF subtrees of the WHERE clause of unplanned and onPremise to the proposals, if possible. Returns
    ///     the new plan with the WHERE expressions distributed.
    /// </summary>
    /// <remarks>
